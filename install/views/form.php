...
<div class="page-header">
    ...
    <h1><?=__("Welcome to")?> Open Booking <?=__("installation")?></h1>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group adv">                
                    ...
                    <input type="text" name="TABLE_PREFIX" value="<?=core::request('TABLE_PREFIX','ob_')?>" class="form-control" data-toggle="tooltip" title="<?=__("Allows multiple installations in one database if you give each one a unique prefix")?>. <?=__("Only numbers, letters, and underscores")?>." required />
                    </div>
                </div>
            </div>
        </div>
